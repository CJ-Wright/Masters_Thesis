...
\begin{eqnarray}
  ...
  \end{bmatrix}
\end{eqnarray}
where $Q$ is the scatter vector, $f_i$ is atomic scattering factor of the $i$th atom, $\vec{u_{i}}$ is the anisotropic displacement parameter (ADP) for the $i$th atom and $r_{ij}$ is the distance between atoms $i$ and $j$ and has $q$ dependence. \cite{Jeong2002}
