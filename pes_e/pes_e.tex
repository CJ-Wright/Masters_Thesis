...
\todo[inline]{Explain the origin of the potentials, especially $\chi^{2}$ and $Rw$}
...
\todo[inline]{Need to discuss Monte Carlo more, including Reverse Monte Carlo}

\subsection{Hamiltonian Monte Carlo}
\todo[inline]{Need to put HMC into the Stat Mech Formalism, it is kinda cannonical, except that it has a random momenta which is specified and not temperature.}
...
\todo[inline]{Need the official criteria for HMC}
