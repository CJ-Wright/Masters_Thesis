...
This implies that the as synthesized PNO structure is stable at least for the \tilde 1 hour that the sample was held at 750 $^\circ$C.

The annealed samples figures, \ref{fig:S2_0_to_40} and \ref{fig:S2_0_to_10}, tell a rather different story.
