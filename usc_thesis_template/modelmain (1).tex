...
\author{Isaac Leonard}{Gauss}    %% First Name then 
                                 %% Last Name

\date{2035}                      %% The year of graduation
...
\otherdegrees{
Bachelor of Arts\\
Harvard College 2028\\ [\baselineskip]
Master of Science\\
...
\advisor {Dr.}{David Hilbert}{Major Professor}  %%% Be sure the 
\readera{Dr.}{Karl Gauss}{Committee Member}     %%% third field is 
\readerb{Dr.}{Charles Parker}{Jazzman}          %%% the one used in 
...
\abstract{herkimer}  %% This calls the file herkimer.tex but 
